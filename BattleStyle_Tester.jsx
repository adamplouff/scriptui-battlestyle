...
var btn_update = buttonColorText(grp_buttons, '#546E7A', 'Refresh');				// refresh button
...
function updateButton(pGrp) {										// draw UI elements
	...
	var btn_reference = buttonColorVector(pGrp, JSON.parse(goodQuotes), cp.text, [60, 24]);			// draw button with new values

	mainPalette.layout.layout(true);								// auto layout
	mainPalette.layout.resize();									// resize everything
}

function getCoordString(index) {									// get coord from icons obj with the dropdown selection name
